...
// Fetch all farmers with a valid grower_no from the authentication table
$query = "SELECT grower_no, firstname, lastname FROM authentication WHERE grower_no IS NOT NULL AND grower_no != '' AND userrole='farmer'";
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Farmers with Grower Number</h3>
                        <?php
