...
<body>
                                                ...
                                                <form method="post" action="users_process.php">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" name="growerno" class="form-control" readonly/>
                                                            <button id="generateGrowerNoBtn" type="button" class="btn btn-primary">
                                                                <i class="fa fa-cog"></i>
                                                            </button>
                                                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            // Event listener for clicking on the generate grower no icon
            $('#generateGrowerNoBtn').on('click', function () {
                var growerNoField = $('#addRecordModal').find('input[name="growerno"]');
                var labelField = $('#addRecordModal').find('small');

                var growerNoValue = growerNoField.val().trim();
                if (growerNoValue === '') {
                    // Show the loading spinner and change the label
                    var icon = $(this).find('i');
                    icon.addClass('fa-spin');
                    labelField.text('Generating Grower No...');

                    // Simulate a delay of 10 seconds
                    setTimeout(function () {
                        // Generate a random 6-digit number
                        var randomNumber = Math.floor(Math.random() * 900000) + 100000;
                        growerNoField.val(randomNumber);

                        // Reset the label and spinner
                        labelField.text('Generate Grower No');
